...
public class HelpCommand extends AbstractPluginCommand {
    ...
    public boolean execute(CommandSender commandSender) {
        ...
        commandSender.sendMessage(ChatColor.AQUA + "/dpm list [installed|available|outdated] - List plugins, optionally filtered; outdated checks for newer builds without installing them.");
